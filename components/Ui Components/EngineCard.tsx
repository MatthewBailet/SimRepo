  ...
  return (
    <Canvas
      style={{
        ...
        borderRadius: "12px",
        background:
          "linear-gradient(165deg, rgb(193, 190, 255), rgb(63, 41, 206))",
      }}
    >
        ...
        <Card className="lg:aspect-[5/1] aspect-[4/3] md:aspect-[3/1] rounded-xl px-10 py-0 sm:py-8 relative overflow-hidden transition-all duration-300 group-hover:scale-[102%] hover:shadow-2xl border border-white/10">
          ...
          <CardContent className="relative flex flex-col items-center mt-6 justify-center h-full">
            <div className="transform -translate-y-4 flex flex-col items-center transition-all duration-300 group-hover:scale-105">
              {/* Icon Circle */}
              <div className="bg-white/20 backdrop-blur-sm group-hover:bg-white/30 transition-all duration-300 rounded-full p-6 md:p-7">
                <Rocket className="w-10 h-10 md:w-12 md:h-12 text-white transition-colors duration-300 group-hover:text-[rgb(221,221,221)]" />
              </div>
              <h3 className="mt-5 text-base text-white/90 font-medium tracking-wide">
