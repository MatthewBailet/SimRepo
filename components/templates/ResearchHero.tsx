...
export default function ResearchHero() {
  ...
  return (
    <section className="relative md:min-h-[55vh] min-h-[70vh] w-[80%] mx-auto rounded-2xl flex items-center justify-center overflow-hidden mt-20 pt-6">
      <motion.canvas
      ...
      />
      <div className="container mx-auto relative z-10 px-6 md:px-20 pt-4">
        <motion.div 
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
