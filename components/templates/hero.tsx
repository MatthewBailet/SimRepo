      ...
      <div className="lg:mt-72 pt-20 lg:pt-42 text-center mt-8 sm:mt-20 md:mt-5 relative z-10">
        <div className="container mx-auto px-4 sm:px-6">
          ...
          >
            ...
            >
              <h1 className="text-5xl sm:text-5xl md:text-6xl lg:text-6xl xl:text-7xl text-slate-800 font-semibold tracking-tight text-left sm:text-left lg:text-center mx-auto px-4 sm:px-0 lg:px-20 w-full lg:w-[80%] leading-tight">
